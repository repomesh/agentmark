...
This was a version bump only for @agentmark-ai/ai-sdk-v4-adapter to align it with other projects, there were no code changes.
...
> **Note:** This package was previously published as `@agentmark/ai-sdk-v4-adapter`.
